...
public class DepositCalculator {
    double complexPercentCalculate(double a, double y, int d) {
    ...
    void importanJob() {
        ...
        if (action == 1) {
            outDoubleVar = simplePercentCalculate(amount, 0.06, period);
        } else if (action == 2) {
            outDoubleVar = complexPercentCalculate(amount, 0.06, period);
        }
